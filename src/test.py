...
if __name__ == '__main__':
    ...
    (Knowledge()).store_paragraphs(10000)
    (CelebrityNews()).store_paragraphs(10000)
    (Featured()).store_paragraphs(10000)
    (Foreign()).store_paragraphs(10000)
    (TravelNews()).store_paragraphs(10000)
    (TopStory()).store_paragraphs(10000)
